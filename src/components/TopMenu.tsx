...
const TopMenu: React.FC = () => {
  ...
  // const [authenticated, setAuthenticated] = React.useState(currentUser.loggedIn);
  React.useEffect(() => {
    ...
    <div>
      ...
      <IonHeader id="main-content">
        <IonToolbar>
          ...
          <IonTitle>
            <img className="logoPic" src={vulogo} />
          </IonTitle>
          ...
          {!mobile && (
            <IonButtons slot="end">
              {currentUser ? (
                <span>
                  <IonButton
                    routerLink={"/queryPage"}
                    className="menuButton rightSide"
                  >
                ...
                >
                  <div className="rightMenuButton searchButton">
                    <b style={{ fontSize: "1.5em" }}>Log In</b>
                  </div>
                </IonButton>
              )}
            </IonButtons>
